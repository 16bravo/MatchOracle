...
if result[0] == 0:
    ...
    teams_query = f"SELECT r.team, t.reference_team, r.points, t.startDate, t.endDate FROM Rankings r LEFT JOIN Teams t ON (r.team = t.team) WHERE year = {last_year} AND month = {last_month} AND day = {last_day}"
